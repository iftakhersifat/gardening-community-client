...
<<<<<<< HEAD
            <p>Email: <a href="" className="text-green-700">support@gardengrow.com</a></p>
            <p>Phone: <a href="" className="text-green-700">+1 234 567 890</a></p>
=======
            <p>
...
<<<<<<< HEAD
            {/* Twitter */}
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="hover:text-green-700 transition">
=======
            <a
...
<<<<<<< HEAD
            {/* Youtube */}
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="hover:text-green-700 transition">
=======
            <a
...
<<<<<<< HEAD
            {/* Facebook */}
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-green-700 transition">
=======
            <a
